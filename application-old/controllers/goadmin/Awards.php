...
class Awards extends CI_Controller {
	...
	// Also for table name
	var $url = 'awards';
	var $model = 'model_awards';
	var $title = 'Awards & Recognitions';

	var $awards_image = TRUE;

	var $thumb_width = 236;
	var $thumb_height = 185;
	...
	public function view($item_id)
	{
		...
		if ($check)
		{
			...
			if ($data['row'][$first]['awards_image']) array_push($asset['js'], 'jquery.imgpreview.min', 'admin/imgpreview');
