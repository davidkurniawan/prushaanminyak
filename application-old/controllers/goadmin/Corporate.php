...
class Corporate extends CI_Controller {
	...
	var $corporate_height = 350;
	var $corporate_width = 185;
	...
	public function view($item_id)
	{
		...
		if ($check)
		{
			...
			if ($data['row'][$first]['corporate_image']) array_push($asset['js'], 'jquery.imgpreview.min', 'admin/imgpreview');
