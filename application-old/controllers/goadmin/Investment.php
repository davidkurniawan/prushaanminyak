...
class Investment extends CI_Controller {
	...
	// Also for table name
	var $url = 'investment';
	var $model = 'model_investment';
	var $title = 'Investment';

	var $investment_image = TRUE;
	...
	public function view($item_id)
	{
		...
		if ($check)
		{
			...
			if ($data['row'][$first]['investment_image']) array_push($asset['js'], 'jquery.imgpreview.min', 'admin/imgpreview');
