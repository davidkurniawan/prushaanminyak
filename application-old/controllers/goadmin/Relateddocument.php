...
class Relateddocument extends CI_Controller {

	// Also for table name
	var $url = 'relateddocument';
	var $model = 'Model_relateddocument';
	var $title = 'Related document';
	
	var $relateddocument_image = TRUE;
	var $relateddocument_doc = TRUE;
	
	var $image_height = 198;
	var $image_width = 140;
	...
	public function view($item_id)
	{
		...
		if ($check)
		{
			...
			if ($data['row'][$first]['relateddocument_image']) array_push($asset['js'], 'jquery.imgpreview.min', 'admin/imgpreview');
