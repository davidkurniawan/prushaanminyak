	...
	public function insert()
	{
		...
		foreach ($language as $lang_data)
		{
			$data = array(
					...
					'faq_name'		=> $this->input->post('faq_name_' . $lang_data['language_id']),
					'seo_url'		=> url_title(trim($this->input->post('faq_name_' . $language[0]['language_id'])), 'underscore', TRUE),
					'faq_content'	=> $this->input->post('faq_content_' . $lang_data['language_id']),
