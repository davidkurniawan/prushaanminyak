        ...
        <div id="form-content">
            <div id="form-left">
                <div class="form-div">
                    ...
                    <input type="hidden" name="section_key" value="<?php echo $row[$lang['language_id']]['article_section']; ?>" />
                    ...
                    <p class="upload">
                        ...
                        <?php else: ?>
                        	<?php if($row[$first]['flag_memo'] == 'Working'): ?>
                            <span class="help">Recommended Resolution: <?php echo $this->working_width, 'px * ', $this->working_height, 'px'; ?></span>
                        <?php else: ?>
                        ...
                        <?php else: ?>
                            <?php if($row[$first]['flag_memo'] == 'Our Bussines Milestone'): ?>
                            <span class="help">Recommended Resolution: <?php echo $this->our_width, 'px * ', $this->our_height, 'px'; ?></span>
                        <?php else: ?>
            ...
            <?php if($row[$first]['flag_memo'] != 'Corporate Values'): ?>
                <?php $x = 0; foreach (language()->result_array() as $lang) : ?>
                    <div class="language lang-<?=$lang['language_code']?>" <?php if ($x == 0) echo 'style="display:block"'; ?>>
                        ...
                        <div class="form-div ckeditor">
                            ...
                            <textarea 
                                <?php 
                                $flag = $row[$lang['language_id']]['flag_memo'];
                                if($flag == 'Visimisi')
                                {
                                    echo "maxlength='$this->mxlength_visi_misi'";
                                }
                                else if($flag == 'Our Bussines Milestone')
                                {
                                    echo "maxlength='$this->mxlength_our_business_milestone'";
                                }
                                else
                                { 
                                    echo '';
                                ...
                                ?> 
                            class="content" name="article_content_<?=$lang['language_id']?>"><?php echo $row[$lang['language_id']]['article_content']; ?></textarea>
                        </div>
                    </div>
                <?php $x++; endforeach; ?>
            <?php endif; ?>
