            ...
            if ($query->result_array()) :
				...
				foreach ($query->result_array() as $item) :
					...
					<tr>
                        ...
                        <td><img width="100" src="<?php echo base_url(), 'images/banner/', $item['banner_image']; ?>" /></td>
						<td><?php echo $item['banner_sort']; ?></td>
                        ...
                        <td class="del">
                        	<a title="Edit &quot;<?php echo $item['banner_name']; ?>&quot;" href="<?php echo base_url(), 'goadmin/', $url, '/view/', $item['unique_id']; ?>" class="input-submit edit">View</a>
                        </td>

                        <td style="text-align: center;">
                        <?php if($item['flag_memo'] != 'Menu Banner'): ?>
