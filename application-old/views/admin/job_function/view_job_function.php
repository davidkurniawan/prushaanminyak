<div id="content">
    <form action="<?php echo base_url(), 'goadmin/', $url, '/view/', $row['unique_id']; ?>" method="post" >
        <input type="hidden" name="id" id="job_function-id" value="<?php echo $row['unique_id']; ?>" />
        
        <?php $this->load->view('admin/template/fixed_heading', array('type' => 'view', 'name' => $row['job_function_name'])); ?>
        ...
        <div id="form-content">
            <div id="form-left">
                <div class="form-div">
                    <h3>Information</h3>   
                    <p>
                        <label for="job_function_name>">Job Name</label>
                        <input type="text" class="input-text required" name="job_function_name" id="job_function_name" value="<?php echo $row['job_function_name']; ?>" />
                    </p>
                </div>
            </div>
