        ...
        <tbody>
            ...
            if ($query->result_array()) :
				...
				foreach ($query->result_array() as $item) :
					$category = $this->db->select('gallery_category_name')->from('gallery_category')->where('unique_id', $item['photo_category'])->get()->row_array();
					...
					<tr>
						...
						<td><?php echo $category['gallery_category_name']; ?></td>
                        
                        <td><img width="100" src="<?php echo base_url(), 'images/photo/', $item['photo_image']; ?>" /></td>
                        ...
                        <td class="del">
                        	<a title="Edit &quot;<?php echo $item['photo_name']; ?>&quot;" href="<?php echo base_url(), 'goadmin/', $url, '/view/', $item['unique_id']; ?>" class="input-submit edit">View</a>
                        </td>
