            ...
            if ($query->result_array()) :
				...
				foreach ($query->result_array() as $item) :
					...
					<tr>
						...
						<td><?php echo $item['publications_name']; ?></td> 
                        <td>
                            <?php echo date('l, d F Y', strtotime($item['publications_start'])); ?>
                        </td>

                        <?php $category = $this->db->get_where('publications_category',array('unique_id' => $item['publications_category']))->row_array(); ?>
                        <td><?php echo $category['publications_category_name']; ?></td> 
                        ...
                        <td class="del">
                        	<a title="Edit &quot;<?php echo $item['publications_name']; ?>&quot;" href="<?php echo base_url(), 'goadmin/', $url, '/view/', $item['unique_id']; ?>" class="input-submit edit">View</a>
                        </td>
