            ...
            if ($query->result_array()) :
                ...
                foreach ($query->result_array() as $item) :
                    ...
                    <tr>
                        ...
                        <td><?php echo $item['publications_category_name']; ?></td>
                        ...
                        <td class="del">
                            <a title="Edit &quot;<?php echo $item['publications_category_name']; ?>&quot;" href="<?php echo base_url(), 'goadmin/', $url, '/view/', $item['unique_id']; ?>" class="input-submit edit">View</a>
                        </td>
