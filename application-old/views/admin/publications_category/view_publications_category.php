...
<!-- <form action="<?php //echo base_url(), 'goadmin/', $url, '/view/', $row['unique_id']; ?>" method="post" >
        <input type="hidden" name="id" id="publications_category-id" value="<?php //echo $row['unique_id']; ?>" />
        
        <?php //$this->load->view('admin/template/fixed_heading', array('type' => 'view', 'name' => $row['publications_category_name'])); ?> -->
