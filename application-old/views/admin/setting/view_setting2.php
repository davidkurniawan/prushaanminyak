	    ...
	    <?php echo $this->session->flashdata('success'); ?>
            <div id="form-left">
                ...
                <div class="form-div">
                    ...
                    <p>
                        <label for="setting_google_map">Google Maps</label>
                        <input type="text" class="input-text" name="setting_google_map" id="setting_google_map" maxlength="100" value="<?php echo $row[0]['setting_google_map']; ?>" />
                        <span class="help">Koordinat Google Maps (contoh: <strong>-6.13773,106.80690</strong>)</span>
                    </p>
                    <p>
