            ...
            if ($query->result_array()) :
				...
				foreach ($query->result_array() as $item) :
					...
					<tr>
						...
						<td><?php echo $item['testimonial_name']; ?></td>
                        <td><?php echo $item['testimonial_content']; ?></td>
                        ...
                        <td class="del">
                        	<a title="Edit &quot;<?php echo $item['testimonial_name']; ?>&quot;" href="<?php echo base_url(), 'goadmin/', $url, '/view/', $item['unique_id']; ?>" class="input-submit edit">View</a>
                            <a id="row-<?php echo $item['unique_id']; ?>" href="javascript:;" class="input-submit delete">Delete</a>
                        </td>
					</tr>
				<?php
                $i++;
