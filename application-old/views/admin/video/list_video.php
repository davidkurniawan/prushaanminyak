            ...
            if ($query->result_array()) :
				...
				foreach ($query->result_array() as $item) :
					...
					<tr>
						...
						<td><a class="text" href="http://www.youtube.com/watch?v=<?php echo $item['video_link']; ?>" title="See this in YouTube" target="_blank">http://www.youtube.com/watch?v=<?php echo $item['video_link']; ?></a></td>
						...
						<td class="del"><a title="Edit &quot;<?php echo $item['video_name']; ?>&quot;" href="<?php echo base_url(), 'goadmin/', $url, '/view/', $item['unique_id']; ?>" class="input-submit edit">View</a></td>
