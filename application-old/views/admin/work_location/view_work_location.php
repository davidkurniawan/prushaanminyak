<div id="content">
    <form action="<?php echo base_url(), 'goadmin/', $url, '/view/', $row['unique_id']; ?>" method="post" >
        <input type="hidden" name="id" id="work_location-id" value="<?php echo $row['unique_id']; ?>" />
        
        <?php $this->load->view('admin/template/fixed_heading', array('type' => 'view', 'name' => $row['work_location_name'])); ?>
            ...
            <div id="form-left">
                <div class="form-div">
                    ...
                    <p>
                        ...
                        <input type="text" class="input-text required" name="work_location_name" id="work_location_name" value="<?php echo $row['work_location_name']; ?>" />
                    </p>
                </div>
            </div>
