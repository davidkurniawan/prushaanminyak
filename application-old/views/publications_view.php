   ...
   <div class="container">
      <div class="row">
         ...
         <div class="col-sm-9">
            ...
            <?php
               $cat = $this->db->get_where('publications_category',array('flag'=>1))->result_array();
               foreach($cat as $row):
               ...
               ?>
                  <div class="col-md-6">
                     <div class="item-sshe tbl item-public">
                        <div class="cell w115">
                           <div class="h140">
                              <img src="<?php echo base_url('images/publications/'.$item['publications_image']);?>" class="img-responsive"/>
                           </div>
                        </div>
                        <div class="cell">
                           <div>
