...
class Banner extends CI_Controller {
	...
	var $image_width = 1903;
	var $image_height = 900;

	var $menu_banner_width = 1687;
	var $menu_banner_height = 350;
	...
	public function view($item_id)
	{
		...
		if ($check)
		{
			...
			if ($data['row'][$first]['banner_image']) array_push($asset['js'], 'jquery.imgpreview.min', 'admin/imgpreview');
