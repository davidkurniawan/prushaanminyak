...

{
	...
	public function getJobFunction()
	{
		...
		$this->db->select("j.*")
		         ->join("job_function j", "j.job_function_id=c.career_job_function","left")
		         ->where("j.flag" , 1);
		return $this->db->get_where('career c',array('c.flag'=>1,'c.language_id'=>$this->lang))->result_array();
...

   {
...

	{
		...
		// $query = $this->db->order_by('banner_sort','DESC');
