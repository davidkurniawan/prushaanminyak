...
define('AXACKFINDER', substr(__FILE__, 0, strpos(__FILE__, "ckfinder")).'ckfinder/');
...
define('CKFINDER_CONNECTOR_CONFIG_FILE_PATH',AXACKFINDER ."config.php");
...
if (CKFINDER_CONNECTOR_PHP_MODE == 4) {
    define('CKFINDER_CONNECTOR_LIB_DIR', AXACKFINDER ."core/connector/php/php4");
} else {
    define('CKFINDER_CONNECTOR_LIB_DIR', AXACKFINDER ."core/connector/php/php5");
}
