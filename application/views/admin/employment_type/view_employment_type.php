<div id="content">
    <form action="<?php echo base_url(), 'goadmin/', $url, '/view/', $row['unique_id']; ?>" method="post" >
        <input type="hidden" name="id" id="employment_type-id" value="<?php echo $row['unique_id']; ?>" />
        
        <?php $this->load->view('admin/template/fixed_heading', array('type' => 'view', 'name' => $row['employment_type_name'])); ?>
            ...
            <div id="form-left">
                <div class="form-div">
                    ...
                    <p>
                        ...
                        <input type="text" class="input-text required" name="employment_type_name" id="employment_type_name" value="<?php echo $row['employment_type_name']; ?>" />
                    </p>
                </div>
            </div>
