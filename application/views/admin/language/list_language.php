            ...
            if ($query->result_array()) :
				...
				foreach ($query->result_array() as $item) :
					...
					<tr>
                        ...
                        <td><img width="50" src="<?php echo base_url(), 'images/language/', $item['language_icon']; ?>" /></td>
                        ...
                        <td class="del">
                        	<a title="View &quot;<?php echo $item['language_name']; ?>&quot;" href="<?php echo base_url(), 'goadmin/', $url, '/view/', $item['unique_id']; ?>" class="input-submit edit">View</a>
                        </td>
