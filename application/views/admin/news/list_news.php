<div id="content">
    ...
    <form class="filter" method="post" action="<?php echo current_url(); ?>">
    	<label for="news_filter">Filter By Type :</label>
    	<select class="input-text" name="news_filter" id="news_filter">
        	<option value="">-- Select Type --</option>
            <option value="1" <?php if ($this->input->post('filter') == '1') echo 'selected="selected"'; ?>>News</option>
            ...
            if ($query->result_array()) :
				...
				foreach ($query->result_array() as $item) :
					...
					<tr>
						...
						<td>
                            <?php echo $item['news_name']; ?>
                        </td>
                        
                        <td>
							<?php if ($item['news_type'] == 1) echo 'News';
							elseif ($item['news_type'] == 2) echo 'Event';
							elseif ($item['news_type'] == 3) echo 'Announcement';
							else echo '--'; ?>
                        </td>

                        <td>
                            <?php echo date('l, d F Y', strtotime($item['news_start'])); ?>
                        </td>

						<?php /*
                        <td>
							<?php if ($item['news_type'] != 2) echo '--'; else echo date('l, d F Y', strtotime($item['news_end'])); ?>
                        </td>
						*/?>
                        ...
                        */?>
                        ...
                        <td class="del">
                        	<a title="Edit &quot;<?php echo $item['news_name']; ?>&quot;" href="<?php echo base_url(), 'goadmin/', $url, '/view/', $item['unique_id']; ?>" class="input-submit edit">View</a>
                        </td>
