<div id="content">
    <form action="<?php echo base_url(), 'goadmin/', $url, '/add'; ?>" method="post" <?php if ($this->phase_image == TRUE) echo 'enctype="multipart/form-data"'; ?>>
    	...
    	<div id="form-content">
            <div id="form-left">
                <div class="form-div">
                    ...
                    <?php $x = 0; foreach (language()->result_array() as $lang) : ?>
                        <div class="language lang-<?=$lang['language_code']?>" <?php if ($x == 0) echo 'style="display:block"'; ?>>
                            <p>
                                ...
                                <input type="text" class="input-text required" name="phase_name_<?=$lang['language_id']?>" id="phase_name_<?=$lang['language_id']?>" />
                            </p>
                        </div>
                    <?php $x++; endforeach; ?>
                    ...
                    <p class="upload">
                        <label for="phase_image">Image</label>
