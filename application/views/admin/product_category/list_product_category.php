        ...
        <tbody>
            ...
            if ($query->result_array()) :
				...
				foreach ($query->result_array() as $item) :
					...
					$parent = $this->db->select('product_category_name')->from('product_category')->where('unique_id', $item['product_category_parent'])->get()->row_array();
					if ($item['flag'] == 1) $color = '#090';
					elseif ($item['flag'] == 2) $color = '#F00'; ?>
					<tr>
						<td align="center"><?php echo $i; ?></td>
						<td><?php echo $item['product_category_name']; ?></td>
                        <td><?php echo (isset($parent['product_category_name'])) ? $parent['product_category_name'] : '--'; ?></td>
                        ...
                        <td class="del">
                        	<a title="Edit &quot;<?php echo $item['product_category_name']; ?>&quot;" href="<?php echo base_url(), 'goadmin/', $url, '/view/', $item['unique_id']; ?>" class="input-submit edit">View</a>
                        </td>
