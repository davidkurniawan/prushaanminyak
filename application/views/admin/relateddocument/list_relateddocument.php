            ...
            if ($query->result_array()) :
				...
				foreach ($query->result_array() as $item) :
					...
					<tr>
						...
						<td><?php echo $item['relateddocument_name']; ?></td> 
                        <td>
                            <?php echo date('l, d F Y', strtotime($item['relateddocument_start'])); ?>
                        </td>
                        ...
                        <td class="del">
                        	<a title="Edit &quot;<?php echo $item['relateddocument_name']; ?>&quot;" href="<?php echo base_url(), 'goadmin/', $url, '/view/', $item['unique_id']; ?>" class="input-submit edit">View</a>
                        </td>
