        ...
        <tbody>
            ...
            if ($query->result_array()) :
				...
				foreach ($query->result_array() as $item) :
                    $phase = $this->db->get_where('phase', array('unique_id' => $item['phase_id']))->row_array();
                    $investment = $this->db->get_where('investment', array('unique_id' => $item['investment_id']))->row_array();
					if ($item['flag'] == 1) $color = '#090';
					elseif ($item['flag'] == 2) $color = '#F00'; ?>
					<tr>
						<td align="center"><?php echo $i; ?></td>
						<td><?php echo $item['set_location_name']; ?></td>
                        
						<td><?php echo $phase['phase_name']; ?></td>
                        
                        <?php //<td><?php //echo $investment['investment_name'];</td> ?>
                        ...
                        <td class="del">
                        	<a title="Edit &quot;<?php echo $item['set_location_name']; ?>&quot;" href="<?php echo base_url(), 'goadmin/', $url, '/view/', $item['unique_id']; ?>" class="input-submit edit">View</a>
                        </td>
