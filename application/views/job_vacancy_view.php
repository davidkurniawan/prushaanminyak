   ...
   <div class="container">
      <div class="row">
         ...
         <div class="col-sm-9">
                           ...
                           <div class="form-group">
                              <label><?php echo $this->lang->line('keyword');?></label>
                                 <div class="input-custom">
                                    <input type="text" class="custom-input" value="<?php echo ($this->input->post('free_search'))? $this->input->post('free_search') : ''?>" name="free_search">
                                 </div>
                           </div>
                        </div>
                        <?php  /*
            ...
            <?php /*
               <div class="title2">
                  <?php echo $this->lang->line('comingsoon');?>
               </div>
               */?>
