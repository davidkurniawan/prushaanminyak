               ...
               <?php
                  if($list_location){
                     foreach ($list_location as $key => $value) {
                        ?>
                           <div class="item-location" data-class="<?php echo $value['seo_url'];?>">
                                                ...
                                                if(!empty($value['set_location_highlights'])){
                                                   ?>
                                                      ...
                                                      <div class="clearfix">
                                                         ...
                                                         <div class="description"><?php echo character_limiter(strip_tags($value['set_location_description_highlights']),150);?></div>
...
$(function() {
   ...
   $('.wrap-list-location .item-location').on('click', function(){
