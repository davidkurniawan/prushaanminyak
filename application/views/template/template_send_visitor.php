<div style="width:600px; margin:0 ; font-family:Arial, Helvetica, sans-serif">
 ...
 '
                    <p style="margin-bottom:15px; font-size:13px;">Hi : <?=$message_name;?> </p><br>
                 
                    <table>
                    <tr><td>Name</td><td> : </td><td><?=$message_name;?></td></tr>
                    <tr><td>Email</td><td> : </td><td><?=$message_email;?></td></tr>
                    <tr><td>Phone Number</td><td> : </td><td><?=$message_phone;?></td></tr>
                    </table>
                    <p style="margin-bottom:15px; font-size:13px;"><?=$message_content;?></p>
        ...
        <div style="margin-top:30px">
            ...
            <div style="float:right;width: 425px;">
                ...
                <div style="float:left; width:270px; text-align: justify">
                    <?php echo $web['setting_address']?str_replace(", ","<br />",$web['setting_address']).'<br />':''; ?>
                </div>
            </div>
