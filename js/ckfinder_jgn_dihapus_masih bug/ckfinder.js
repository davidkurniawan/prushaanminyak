...
(function() {
    ...
    (function() {
        ...
        CKFinder.setupFCKeditor = function(f, g, h, i) {
            ...
            f.Config.LinkUploadURL = 'goadmin/ckfinder/connector?command=QuickUpload&type=Files';
            f.Config.ImageUploadURL = 'goadmin/ckfinder/connector?command=QuickUpload&type=' + (h || 'Images');
            f.Config.FlashUploadURL = 'goadmin/ckfinder/connector?command=QuickUpload&type=' + (i || 'Flash');
        };
        CKFinder.setupCKEditor = function(f, g, h, i) {
            ...
            f.config.filebrowserUploadUrl = 'goadmin/ckfinder/connector?command=QuickUpload&type=Files';
            f.config.filebrowserImageUploadUrl = 'goadmin/ckfinder/connector?command=QuickUpload&type=' + (h || 'Images');
            f.config.filebrowserFlashUploadUrl = 'goadmin/ckfinder/connector?command=QuickUpload&type=' + (i || 'Flash');
        };
    })();
    if (!a.event) {
        a.event = function() {};
    ...
    a.config = {
        ...
        connectorPath: '/goadmin/ckfinder/connector'
    };
